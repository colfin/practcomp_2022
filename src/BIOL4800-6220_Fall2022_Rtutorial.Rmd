...
```{r}
gp <- read.csv("/Users/colinfinlay/GitHub/biol48006220_Fall2022/practcomp_2022/data/gapminder_all.csv")
...
```{r}
ggsave(filename = "/Users/colinfinlay/GitHub/biol48006220_Fall2022/practcomp_2022/data/AfricanLifeExp.png", plot = AfricanLifeExp, width = 24, height = 40, dpi = 300, units = "cm")
```
...
```{r}
write.table(gapminder, file="/Users/colinfinlay/GitHub/biol48006220_Fall2022/practcomp_2022/data/gapminder_web.csv", sep = ",")
```
